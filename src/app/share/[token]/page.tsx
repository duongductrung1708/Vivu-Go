...
import { Calendar, Users, DollarSign, ArrowLeft, Lock, Edit, MapPin, Clock, Globe } from "lucide-react";
        ...
        <Card className="overflow-hidden border-2 shadow-lg bg-linear-to-br from-card to-card/50">
          ...
          <CardContent className="relative z-10 space-y-6">
            ...
            {(() => {
              ...
              return (daysCount > 0 || placesCount > 0) && (
                ...
                <div className="flex items-start gap-3 p-4 rounded-lg bg-muted/50 border">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="font-semibold text-lg">
                      {format(new Date(itinerary.start_date), "dd/MM/yyyy", { locale: vi })}
                    </div>
                    {itinerary.end_date && (
                      <div className="text-sm text-muted-foreground mt-1">
                        → {format(new Date(itinerary.end_date), "dd/MM/yyyy", { locale: vi })}
                      </div>
                    )}
                  </div>
                </div>
              ...
              {itinerary.people_count > 0 && (
                <div className="flex items-start gap-3 p-4 rounded-lg bg-muted/50 border">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="font-semibold text-lg">{itinerary.people_count} người</div>
                  </div>
                </div>
              )}
